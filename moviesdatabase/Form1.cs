        ...
        private void btnAddCustomer_Click_1(object sender, EventArgs e)
        {
            ...
            if ((txtFirstName.Text != string.Empty) && (txtLastName.Text != string.Empty))
            {
                try
                {
                    ...
                    result = myDatabase.InsertOrUpdateCustomersstring(txtFirstName.Text, txtLastName.Text, txtCustID.Text, txtAddress.Text, txtPhone.Text, "Add");
        ...
        private void btnUpdateCustomer_Click(object sender, EventArgs e)
        {
            ...
            if ((txtFirstName.Text != string.Empty) && (txtLastName.Text != string.Empty))
            {
                try
                {
                    ...
                    result = myDatabase.InsertOrUpdateCustomersstring(txtFirstName.Text, txtLastName.Text, txtCustID.Text, txtAddress.Text, txtPhone.Text,  "Update");
