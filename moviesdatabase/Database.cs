...
namespace moviesdatabase
{
    public class Database
    {
        ...
        {
            connectionString =
               @"Data Source=DESKTOP-SKQ2HVE\SQLEXPRESS;Initial Catalog=VBMoviesFullData;Integrated Security=True;Connect Timeout=30";
        ...
        public string InsertOrUpdateCustomersstring(string FirstName, string LastName, string CustID, string Address, string Phone, string AddOrUpdate)
        {
            try
            {
                ...
                if (AddOrUpdate == "Add")
                {
                    ...
                    string query = "Insert Into Customer (FirstName, LastName,  Address, Phone) " +
                ...
                {
                    var myCommand =
                        new SqlCommand("Update Customer set FirstName = @FirstName, LastName = @LastName, Address = @Address, Phone = @Phone where CustID = @CustID ",
                            Connection);
